...
__STATIC_INLINE uint8_t DAP_GetSerNumString (char *str) {
    sprintf(str, "%08X-%08X-%08X", (*( uint32_t *)0x1FFFF7E8),(*( uint32_t *)0x1FFFF7EC),(*( uint32_t *)0x1FFFF7F0));
    return strlen(str) + 1;
}
...
/**/
#define PIN_DI  GPIO_Pin_5
#define PORT_DI GPIOA
/**/
#define PIN_DO  GPIO_Pin_12
#define PORT_DO GPIOB
/**/
#define PIN_DIR  GPIO_Pin_13
#define PORT_DIR GPIOB
/**/
#define PIN_TDI GPIO_Pin_15
#define PORT_TDI GPIOB
/**/
...
__STATIC_INLINE void PORT_JTAG_SETUP (void) {
    ...
    //DIR
    GPIO_InitStructure.GPIO_Pin = PIN_DIR ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(PORT_DIR, &GPIO_InitStructure);
    GPIO_SetBits(PORT_DIR, PIN_DIR );   
    // SWD IO
    GPIO_InitStructure.GPIO_Pin = PIN_DI ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(PIN_DI, &GPIO_InitStructure);

    GPIO_InitStructure.GPIO_Pin = PIN_DO ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(PORT_DO, &GPIO_InitStructure);
    GPIO_SetBits(PORT_DO, PIN_DO );
    // TDI TDO
    GPIO_InitStructure.GPIO_Pin = PIN_TDI;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(PORT_TDI, &GPIO_InitStructure);
    GPIO_SetBits(PORT_TDI, PIN_TDI);

    GPIO_InitStructure.GPIO_Pin = PIN_TDO;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(PORT_TDO, &GPIO_InitStructure);
    // RST
    GPIO_InitStructure.GPIO_Pin = PIN_nRESET;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(PORT_nRESET, &GPIO_InitStructure);
    GPIO_SetBits(PORT_nRESET, PIN_nRESET);
}
...
//    return GPIO_ReadOutputDataBit(GPIOB, PIN_CLK);
    return (PORT_CLK->OUTDR & PIN_CLK) != 0;
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_ENABLE  (void) {
    ...
    PORT_DIR->BSHR = PIN_DIR;
//    volatile uint32_t count = 50;
//     while (--count);   
    // GPIOC->CFGLR &= ~((uint32_t)0x0F << 24);
    // GPIOC->CFGLR |= (uint32_t)0x03 << 24;               /*PC6 by liguang*/
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_DISABLE (void) {
    ...
    PORT_DIR->BCR = PIN_DIR;
    // volatile uint32_t count = 50;
    // while (--count);   
    // GPIOC->CFGLR &= ~((uint32_t)0x0F << 24);
    // GPIOC->CFGLR |= (0x04 << 24); /*PC6 by liguang*/
}
...
__STATIC_FORCEINLINE uint32_t PIN_TDI_IN  (void) {
    return (PORT_TDI->OUTDR & PIN_TDI) != 0;
}
...
__STATIC_FORCEINLINE void     PIN_TDI_OUT (uint32_t bit) {
    if(bit & 0x01)
    {
        PORT_TDI->BSHR = PIN_TDI;
    }
    else
    {
        PORT_TDI->BCR = PIN_TDI;
    }
}
...
__STATIC_FORCEINLINE uint32_t PIN_TDO_IN  (void) {
    return (PORT_TDO->INDR & PIN_TDO) != 0;
}
...
__STATIC_FORCEINLINE uint32_t PIN_nRESET_IN  (void) {
    return (PORT_nRESET->OUTDR & PIN_nRESET) != 0;
}
...
__STATIC_FORCEINLINE void     PIN_nRESET_OUT (uint32_t bit) {
    ...
    extern void target_nvic_system_reset(void);
    if(bit != 0)
    {
        PORT_nRESET->BSHR = PIN_nRESET;
    }
    else
    {
        PORT_nRESET->BCR = PIN_nRESET;
        target_nvic_system_reset();
    }
